...
@section('content')
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-blue-900 mb-6">📊 Moje statystyki</h1>
            ...
            <table class="w-full">
                ...
                @forelse($rsvps as $rsvp)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-gray-600">{{ \Carbon\Carbon::parse($rsvp->data_i_czas_start)->format('d.m.Y H:i') }}</td>
